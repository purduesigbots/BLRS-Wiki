...
Additional on-board features include a [3.3 V voltage regulator](https://www.ti.com/product/LM2937) for the entire system to be connected to a power supply or VEX Cortex via a VEX PWM Cable. Data is returned to the [VEX Cortex](../../vex-electronics/legacy/vex-cortex.md) via an [I2C](i2c.md) connection, with a second I2C port for adding a [gyro](../../vex-electronics/vex-sensors/3-pin-adi-sensors/gyroscope.md) or VEX Motor Encoder. TVS diodes are also installed to protect the I2C bus from ESD. All the electrical engineering and firmware development for this board was done by Purdue SIGBOTS.
