...
In [VEXCode](../../../software/vex-programming-software/vex-coding-studio-vcs.md), the Yaw Rate Gyroscope returns the angle of rotation in degrees. However, in [PROS](../../../software/vex-programming-software/pros/), the Yaw Rate Gyroscope returns the angle of rotation in decidegrees (tenths of a degree). This means that rather than receiving a reading of 360 degrees, it will return 3600 decidegrees instead.
