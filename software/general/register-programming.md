...
This code looks very little like C; most constants are in hexadecimal, most variables have unintuitive names, and familiar constructs such as while loops are distorted to the point of confusion. Since this type of code is seldom self-documenting, good [code style](../organizing-code/code-styling-guide.md) dictates a descriptive comment for nearly every line.
